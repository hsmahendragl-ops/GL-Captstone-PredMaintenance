...
mlflow.set_experiment("MLOps_GL_Predictive_Maintenance_experiment01")
print("Experiment Name: MLOps_GL_Predictive_Maintenance_experiment01")

# DATASET LOADING AND CLEANING
# Define constants for the dataset and output paths
DATASET_PATH = "hf://datasets/HSMahendraGL/predictive_maintenance/engine_data.csv"
df_pred_maint = pd.read_csv(DATASET_PATH)
print("Dataset loaded successfully.")

target_col = 'Engine Condition'

# Split into X (features) and y (target)
X = df_pred_maint.drop(columns=[target_col])
y = df_pred_maint[target_col]
...
# Dataset has 12000+ 1's as compared to 7000+ 0's
...
with mlflow.start_run():
    ...
    mlflow.log_metrics({
      ...
      "train_precision": train_report.get('1', {}).get('precision', 0.0),
      "train_recall": train_report.get('1', {}).get('recall', 0.0),
      "train_f1-score": train_report.get('1', {}).get('f1-score', 0.0),
      ...
      "test_f1-score": test_report.get('1', {}).get('f1-score', 0.0)
    })
    ...
    model_path = "best_maintainance_predictor_model_v1.joblib"
    ...
    repo_id = "HSMahendraGL/predictive_maintenance"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="best_maintainance_predictor_model_v1.joblib",
        path_in_repo="best_maintainance_predictor_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
